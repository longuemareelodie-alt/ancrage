...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Validate caller is an authenticated admin (JWT verification is not enforced
    // at the gateway for this function — check in code, matching send-batch-payout-emails).
