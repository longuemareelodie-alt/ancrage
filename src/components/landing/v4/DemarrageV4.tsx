...
const DemarrageV4 = () => (
  <Band>
    <div className="rounded-2xl border border-border/60 bg-night px-5 py-7 text-night-foreground md:px-10 md:py-9">
      ...
      <p className="mt-4 text-[14px] text-night-foreground/75">
