  ...
  return (
    <section id="rejoindre" className="px-5 pb-4 pt-2 md:px-6 md:pb-8 md:pt-4">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-2 text-[15px] font-medium text-night">
        ...
        <button
          ...
          disabled={loading}
          className="mt-3 inline-flex min-h-[50px] items-center justify-center gap-2 rounded-full bg-night px-7 text-[15px] font-medium text-night-foreground transition-transform hover:-translate-y-[1px] disabled:opacity-60"
        >
          Je rejoins Éclosia
