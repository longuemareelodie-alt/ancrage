...
const Auth = () => {
  ...
  const handleGoogle = async () => {
    ...
    try {
      ...
      if (result.error) setError(result.error.message || t("auth.google_error"));
    } catch (err: any) {
        ...
        {isForgot ? (
          ...
          <>
            ...
            <div className="relative flex items-center justify-center">
              ...
              <span className="relative bg-background px-3 text-xs text-muted-foreground">{t("auth.or")}</span>
            </div>
